...
import 'package:fridge_app/features/settings/widgets/members_bottom_sheet.dart';
                      ...
                      children: [
                        ...
                        if (selectedFridge != null)
                          AppSettingsListTile(
                            ...
                            subtitle: AppStrings.viewAndManageMembers,
                            onTap: () {
                              showModalBottomSheet(
                                context: context,
                                isScrollControlled: true,
                                backgroundColor: Colors.transparent,
                                builder:
                                    (context) => const MembersBottomSheet(),
                              );
                            },
                          ),
                      ],
